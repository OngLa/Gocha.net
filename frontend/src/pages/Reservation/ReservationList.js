    ...
    <div className={styles.reservationList}>
      {isLoading ? (
        ...
        <>
          ...
          >
            <div>
              <ReservationComponent list={list} refreshList={refreshList} />
            </div>
            <div className={styles.largeButtonWrap}>
              <LargeButton onClick={handleNavOnClick}>새 예약 등록</LargeButton>
            </div>
          </div>
          <img
            src={imgMoveTop}
